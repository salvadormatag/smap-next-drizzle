...
__export(index_exports, {
  ...
  SmapAuth: () => SmapAuth,
  SmapDateFormats: () => SmapDateFormats,
  SmapInstants: () => skeleton,
  SmapInstantsFormatter: () => SmapInstantsFormatter,
  SmapLocales: () => SmapLocales,
  SmapPasswordStrength: () => SmapPasswordStrength,
  SmapUserRole: () => SmapUserRole,
  UnitsDate: () => UnitsDate
});
...
var Navbar = ({ items }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: navRef, className: navigator_default.navigator_navbar, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: navigator_default.ItemNavigator, children: items.map((item, index) => {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            import_link.default,
            {
              ...
              children: [
                item.label,
                item.options && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                  "\xA0",
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItemIcon, { iconKey: arrow, isActive })
                ] })
              ]
            }
          ),
          submenuAvailable && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: navigator_default.MenuSubmenuOptions, "data-render": "SubmenuContainer", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItemSubmenu, { ...submenuProps }) })
        ]
      },
      index
    );
...
var Sidebar = ({ items }) => {
  ...
  const activeParentIndex = (0, import_react2.useMemo)(() => {
    return items.findIndex((item) => {
      if (item.slug === pathname) return true;
      return item.options?.some((subItem) => subItem.slug === pathname);
    });
  }, [items, pathname]);
  const [manualIndex, setManualIndex] = (0, import_react2.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: navigator_default.navigator_sidebar, children: items.map((item, index) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: cssItemNavigator, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "div",
        {
          className: navigator_default.MenuItemLink,
          "data-active": isActive,
          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_link2.default, { href: item.slug, children: [
            isActive ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RocketIcon, { size: 16, className: "text-red-500" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MenuItemIcon, { iconKey: iconLink?.icon || "bug", isActive }),
            item.label
          ] })
        }
      ),
      isItemOpen && item.options && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: navigator_default.MenuSubmenuOptions, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MenuItemSubmenu, { ...submenuProps }) })
    ] }, index);
  }) });
};
...
function NavigatorComponent(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: features.model === "NAVBAR" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Navbar, { ...props }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Sidebar, { ...props }) });
}
...
function MenuItemSubmenu(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: item.options?.map((option, subIndex) => {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          import_link3.default,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(MenuItemIcon, { iconKey: iconLink?.icon || "bug", isActive }),
              option.label
            ]
          }
        )
...
function MenuItemIcon(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(IconComponent, { className: cn(
...
var SmapAuthSchema = import_zod.z.object({
  email: import_zod.z.email({ message: "L'email no sembla una adre\xE7a de correu electr\xF2nic v\xE0lida." }).toLowerCase().trim(),
  password: import_zod.z.string().min(12, { message: "Per la teva propia seguretat, recomanem un m\xEDnim de 12 car\xE0cters." }).max(100).refine((val) => /[A-Z]/.test(val), {
...
var SmapAuth = class {
  ...
  static async hashPassword(password) {
    return await (0, import_argon2.hash)(password);
  }
  /**
